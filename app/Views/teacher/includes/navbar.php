<?php
$name = $_SESSION['user']['full_name'] ?? 'Teacher';
...
foreach ($segments as $seg) {
  if (in_array($seg, ['teacher', 'emodule2', 'public']))
    continue;
...
<div class="topbar">
  ...
  <div>
    ...
    <nav class="topbar-breadcrumb">
      <a href="<?= baseurl('/teacher/dashboard') ?>">Home</a>
  ...
  <div class="topbar-right">
    ...
    <div class="topbar-user">
      ...
      <div class="topbar-user-info">
        ...
        <div class="topbar-user-role">Teacher</div>
      </div>
    </div>
    <div class="topbar-divider"></div>
...
<script nonce="<?= csp_nonce() ?>">
  (function () {
    function updateDate() {
      var el = document.getElementById('topbar-date-text');
      if (!el) return;
