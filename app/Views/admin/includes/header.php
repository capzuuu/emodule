...
<head>
  ...
  <title><?= htmlspecialchars($pageTitle ?? 'Admin') ?> — E-Module LMS</title>
  ...
  <script>
    (function () {
      ...
      var pct = parseInt(localStorage.getItem('adminFontSize'));
      if (map[pct]) {
        document.documentElement.style.fontSize = map[pct] + 'px';
      }
    })();
  </script>
</head>